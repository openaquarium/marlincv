...
const ExperienceSection = () => {
    ...
    const handleExperienceResponsibilityChange = (expIndex: number, respIndex: number, e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
        const { name, value } = e.target
        const newExperience = [...experience]
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center space-x-2">
                                        <Checkbox
                                            ...
                                            onCheckedChange={(checked) => handleInputChange(expIndex, { target: { name: 'selected', value: checked } })}
                                                        ...
                                                        >
                                                            ...
                                                            <Checkbox
                                                                ...
                                                                onCheckedChange={(checked) => 
                                                                    handleExperienceResponsibilityChange(expIndex, respIndex, { target: { name: 'selected', value: checked } })}
                                                            ...
                                                            <Input
                                                                ...
                                                                value={resp.text}
                                                                name="text"
                                                                onChange={(e) => handleExperienceResponsibilityChange(expIndex, respIndex, e)}
                                                            />
